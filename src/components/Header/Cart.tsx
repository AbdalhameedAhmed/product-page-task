  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={clsx(
          "absolute -right-4 z-30 w-[400px] origin-[90%_0%] scale-0 space-y-2 rounded-lg border border-gray-200 bg-white px-4 py-6 shadow-xl transition-all duration-300",
          {
            "scale-100": isOpen,
          },
        )}
